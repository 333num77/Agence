 ...
 */
export type ResearchType = 'MARKET_ANALYSIS' | 'COMPETITOR_ANALYSIS' | 'TECHNOLOGY_RESEARCH' | 'PRICING_RESEARCH' | 'DOCUMENTATION_RESEARCH' | 'OPEN_SOURCE_RESEARCH';
/**
 ...
 * Decision types
 */
export type DecisionType = 'PRODUCT_VIABILITY' | 'FEATURE_PRIORITY' | 'TECH_STACK' | 'MVP_SCOPE' | 'GO_TO_MARKET' | 'SECURITY_RISK' | 'COMPLIANCE_RISK';
export type RecommendationAction = 'PROCEED' | 'PROCEED_WITH_CHANGES' | 'PAUSE_FOR_VALIDATION' | 'PIVOT' | 'ABANDON';
/**
 ...
 */
export type PlanningArtifact = 'PRD' | 'ARCHITECTURE' | 'DATABASE_SCHEMA' | 'API_CONTRACTS' | 'ROADMAP' | 'DEVELOPMENT_PHASES' | 'AI_EXECUTION_PLAN' | 'SECURITY_PLAN' | 'TEST_STRATEGY';
/**
 ...
 * Output formats
 */
export type OutputFormat = 'MARKDOWN' | 'PDF' | 'ZIP' | 'CURSOR_PROJECT' | 'GITHUB_REPO' | 'FIGMA_SPEC' | 'JIRA_BOARD';
/**
